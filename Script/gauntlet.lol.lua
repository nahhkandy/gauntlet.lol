...
local creditsList = {
    {
        name = "nahhkandy",
        role = "former owner, lead scripter and public ver. publisher",
        userId = 6013807291,
        profileLink = "https://www.roblox.com/users/6013807291/profile"
    },
    {
        name = "unfite",
        role = "new owner and helper",
        userId = 889093100,
        profileLink = "https://www.roblox.com/users/889093100/profile"
    },
    {
        name = "koichinshehe",
        role = "ui design",
        userId = 4496426457,
        profileLink = "https://www.roblox.com/users/4496426457/profile"
    },
    {
        name = "GameChipDelta",
        role = "scripter",
        userId = 245490641,
        profileLink = "https://www.roblox.com/users/245490641/profile"
    },
    {
        name = "areuxs",
        role = "other stuff",
        userId = 332520715,
        profileLink = "https://www.roblox.com/users/332520715/profile"
    }
}
...
function setclipboard(text)
    ...
    elseif setclipboard then
        ...
        notify("Error", "Your exploit doesn't support clipboard functions", "error", 3)
    end
end
...
local CreditsButton = createNavButton("Credits", 0.29)
...
MiscScrollingFrame.CanvasSize = UDim2.new(0, 0, 1, 0)
...
CreditsFrame.Size = UDim2.new(0.8, 0, 0.7, 0)
CreditsFrame.Position = UDim2.new(0.1, 0, 0.2, 0)
...
CreditsTitle.Size = UDim2.new(1, 0, 0.1, 0)
CreditsTitle.Position = UDim2.new(0, 0, 0, 0)
CreditsTitle.BackgroundTransparency = 1
CreditsTitle.Text = "Credits"
CreditsTitle.TextColor3 = Color3.fromRGB(250, 227, 54)
...
CreditsScrollingFrame.Size = UDim2.new(1, 0, 0.9, 0)
CreditsScrollingFrame.Position = UDim2.new(0, 0, 0.1, 0)
CreditsScrollingFrame.BackgroundTransparency = 1
CreditsScrollingFrame.ScrollBarThickness = 7
CreditsScrollingFrame.Parent = CreditsFrame

local Ok = Instance.new("UIListLayout", CreditsScrollingFrame)

CreditsScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, Ok.AbsoluteContentSize.Y)
...
local function createCreditEntry(data, index)
    local yPos = (index - 1) * 0.22
    
    local EntryFrame = Instance.new("Frame")
    EntryFrame.Name = data.name .. "Entry"
    EntryFrame.Size = UDim2.new(0.9, 0, 0.2, 0)
    EntryFrame.Position = UDim2.new(0.05, 0, yPos, 0)
    EntryFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 45)
    EntryFrame.BorderSizePixel = 0
    EntryFrame.Parent = CreditsScrollingFrame
    ...
    Headshot.Position = UDim2.new(0.05, 0, 0.5, -30)
    Headshot.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
    Headshot.Image = ""
    Headshot.Parent = EntryFrame
    
    pcall(function()
        Headshot.Image = Players:GetUserThumbnailAsync(data.userId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
    end)
    ...
    NameButton.Size = UDim2.new(0.6, 0, 0.3, 0)
    NameButton.Position = UDim2.new(0.35, 0, 0.2, 0)
    NameButton.BackgroundTransparency = 1
    NameButton.Text = data.name
    NameButton.TextColor3 = Color3.fromRGB(64, 156, 255)
    NameButton.TextSize = 18
    NameButton.Font = Enum.Font.GothamBold
    NameButton.TextXAlignment = Enum.TextXAlignment.Left
    NameButton.Parent = EntryFrame
    
    local Underline = Instance.new("Frame")
    Underline.Name = "Underline"
    Underline.Size = UDim2.new(0, 0, 0, 1)
    Underline.Position = UDim2.new(0, 0, 1, 0)
    Underline.BackgroundColor3 = Color3.fromRGB(64, 156, 255)
    Underline.BorderSizePixel = 0
    Underline.Parent = NameButton
    
    NameButton.MouseEnter:Connect(function()
        TweenService:Create(Underline, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 0, 1)}):Play()
    end)
    
    NameButton.MouseLeave:Connect(function()
        TweenService:Create(Underline, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 1)}):Play()
    end)
    
    NameButton.MouseButton1Click:Connect(function()
        setclipboard(data.profileLink)
        notify("Profile Link Copied", "Copied " .. data.name .. "'s profile link to clipboard!", "info", 3)
    end)
    
    local RoleLabel = Instance.new("TextLabel")
    RoleLabel.Name = "RoleLabel"
    RoleLabel.Size = UDim2.new(0.6, 0, 0.4, 0)
    RoleLabel.Position = UDim2.new(0.35, 0, 0.5, 0)
...
for i, credit in ipairs(creditsList) do
    createCreditEntry(credit, i)
end
